<x-admin::layouts>
    ...
    <!-- Blog Edit Form -->
    <x-admin::form :action="route('admin.blog.category.store')" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex flex-col gap-2 flex-1 max-xl:flex-auto">
                ...
                <div class="p-4 bg-white dark:bg-gray-900 rounded box-shadow">
                    ...
                    <x-admin::form.control-group class="mb-2.5">
                        ...
                        <v-field type="text" name="name" value="{{ old('name') }}" label="{{ trans('blog::app.category.name') }}" rules="required" v-slot="{ field }">
                    ...
                    <x-admin::form.control-group class="mb-2.5">
                        ...
                        <v-field type="text" name="slug" value="{{ old('slug') }}" label="{{ trans('blog::app.category.slug') }}" rules="required" v-slot="{ field }">
                ...
                <div class="p-4 bg-white dark:bg-gray-900 rounded box-shadow">
                    ...
                    <v-description>
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="textarea" name="description" id="description" class="description" rules="required" :value="old('description')" :label="trans('blog::app.category.description')" :tinymce="true" :prompt="core()->getConfigData('general.magic_ai.content_generation.category_description_prompt')">
                            </x-admin::form.control-group.control>
                ...
                <x-admin::accordion>
                    ...
                    <x-slot:content>
                        ...
                        <div class="flex flex-col gap-[12px]">
                            <x-admin::tree.view input-type="radio" name-field="parent_id" value-field="key" id-field="key" model-value="json_encode($categories)" :items="json_encode($categories)" :fallback-locale="config('app.fallback_locale')">
                            </x-admin::tree.view>
                        </div>
