                ...
                <div class="p-4 w-50 bg-white dark:bg-gray-900 rounded-[4px] box-shadow">
                    ...
                    <div class="mt-8">
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="number" name="blog_post_per_page" id="blog_post_per_page" {{-- rules="required" --}} :value="old('blog_post_per_page') ?? $settings['blog_post_per_page']" label="Per Page Records" min="1">
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="number" name="blog_post_maximum_related" id="blog_post_maximum_related" {{-- rules="required" --}} :value="old('blog_post_maximum_related') ?? $settings['blog_post_maximum_related']" label="Maximum Related Posts Allowed" min="1">
                            </x-admin::form.control-group.control>
                ...
                <div class="p-4 w-50 bg-white dark:bg-gray-900 rounded-[4px] box-shadow">
                    ...
                    <div class="mt-8">
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="number" name="blog_post_maximum_nested_comment" id="blog_post_maximum_nested_comment" {{-- rules="required" --}} :value="old('blog_post_maximum_nested_comment') ?? $settings['blog_post_maximum_nested_comment']" label="Allowed maximum nested comment level" min="2" max="4">
                            </x-admin::form.control-group.control>
                ...
                <div class="p-4 w-50 bg-white dark:bg-gray-900 rounded-[4px] box-shadow">
                    ...
                    <div class="mt-8">
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="text" name="blog_seo_meta_title" id="blog_seo_meta_title" :value="old('blog_seo_meta_title') ?? $settings['blog_seo_meta_title']" label="Meta Title">
                            </x-admin::form.control-group.control>
                        </x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="text" name="blog_seo_meta_keywords" id="blog_seo_meta_keywords" :value="old('blog_seo_meta_keywords') ?? $settings['blog_seo_meta_keywords']" label="Meta Keywords">
                            </x-admin::form.control-group.control>
                        </x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="textarea" name="blog_seo_meta_description" id="blog_seo_meta_description" :value="old('blog_seo_meta_description') ?? $settings['blog_seo_meta_description']" label="Meta Description">
                            </x-admin::form.control-group.control>
                        </x-admin::form.control-group>
