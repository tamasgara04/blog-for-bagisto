                        ...
                        <div class="container-right row no-margin col-12 no-padding">
                            <section class="blog-hero-wrapper">
                                <div class="blog-hero-image">
                                    <h1 class="hero-main-title">{{ $blog->translation($currentLocale->code)->name  }}</h1>
                                    <img src="{{ '/storage/' . ( ( isset($blog->src) && !empty($blog->src) && !is_null($blog->src) ) ? $blog->src : 'placeholder-banner.jpg' ) }}" alt="" class="card-img img-fluid img-thumbnail bg-fill">
                                </div>
                            </section>
                            <div id="blog" class="container mt-5">
                                        ...
                                        <div class="column-9">
                                            <section class="blog-content">
                                                <div class="text-justify mb-3 blog-post-content">
                                                    <h3 class="page-title">{{ $blog->translation($currentLocale->code)->name }}</h3>
                                                    ...
                                                    {!! $blog->translation($currentLocale->code)->description !!}
                                                </div>
                                            </section>
                                        </div>
                                        ...
                                        <sidebar class="column-3 blog-sidebar">
                                            <div class="row">
                                                <div class="col-lg-12 mb-4 categories">
                                                    <h3>@lang('blog::app.shop.velocity.categories')</h3>
                                                    <ul class="list-group">
                                ...
                                <div id="comment-list" class="column-12 comment-part related-bolg-part">
                                    <div class="col-lg-12">
                                        <h1 class="mb-3 page-title">@lang('blog::app.shop.velocity.related_blog')</h1>
                                    </div>
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="form-group column-6">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="name" placeholder="{{ trans('blog::app.shop.comment.your_name') }}" required="required" class="form-control" value="{{ ( isset($loggedIn_user_name) && !empty($loggedIn_user_name) && !is_null($loggedIn_user_name) ) ? $loggedIn_user_name : ''; }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group column-6">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="email" name="email" placeholder="{{ trans('blog::app.shop.comment.your_email') }}" required="required" class="form-control" value="{{ ( isset($loggedIn_user_email) && !empty($loggedIn_user_email) && !is_null($loggedIn_user_email) ) ? $loggedIn_user_email : ''; }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <textarea name="comment" placeholder="{{ trans('blog::app.shop.comment.your_comment') }}" required="required" rows="5" class="form-control"></textarea>
                                                                </div>
