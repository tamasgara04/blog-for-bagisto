...
<x-shop::layouts>
    {{-- Page Title --}}
    <x-slot:title>
        @lang('blog::app.shop.author.author_page')
        </x-slot>
                        ...
                        <div class="container-right row no-margin col-12 no-padding">
                            <div id="blog" class="container mt-5">
                                <div class="full-content-wrapper">
                                    <div class="col-lg-12">
                                        <h1 class="mb-3 page-title">@lang('blog::app.shop.blog.posts_by_author', ['author' => $author_data->author]) </h1>
                                    </div>
                                    <div class="flex flex-wrap grid-wrap">
                                        ...
                                        <div class="column-9">
                                            ...
                                            <div class="flex flex-wrap blog-grid-list">
                                                ...
                                                <div class="blog-post-item">
                                                    <div class="blog-post-box">
                                                        <div class="card mb-5">
                                                            <div class="blog-grid-img"><img src="{{ '/storage/' . ( ( isset($blog->src) && !empty($blog->src) && !is_null($blog->src) ) ? $blog->src : 'placeholder-thumb.jpg' ) }}" alt="{{ $blog->translation($currentLocale->code)->name }}" class="card-img-top">
                                                            </div>
                                                            <div class="card-body">
                                            ...
                                            <div class="post-not-available">@lang('blog::app.shop.author.no_posts')</div>
                                        ...
                                        <div class=" column-3 blog-sidebar">
                                            <div class="row">
                                                <div class="col-lg-12 mb-4 categories">
                                                    <h3>@lang('blog::app.shop.author.categories')</h3>
                                                    <ul class="list-group">
                                                    ...
                                                    <div class="tags-part">
                                                        <h3>@lang('blog::app.shop.author.tags')</h3>
                                                        <div class="tag-list">
                                                            @foreach($tags as $tag)
