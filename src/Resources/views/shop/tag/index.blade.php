...
<x-shop::layouts>
    {{-- Page Title --}}
    <x-slot:title>
        @lang('blog::app.shop.tag.page_title')
        </x-slot>
                                ...
                                <div class="full-content-wrapper">
                                    ...
                                    <section class="blog-hero-wrapper">
                                        <div class="blog-hero-image" style="height: 100px;">
                                            <h1 class="hero-main-title">{{ $tag->translation($currentLocale->code)->name }}</h1>
                                        </div>
                                    </section>
                                    <div class="flex flex-wrap grid-wrap">
                                        ...
                                        <div class="column-12">
                                            <div class="text-justify blog-post-content">
                                                {!! $tag->translation($currentLocale->code)->description !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="column-9">
                                                    ...
                                                    <div class="blog-post-box">
                                                        <div class="card mb-5">
                                                            ...
                                                            <div class="card-footer">
                                                                <a href="{{ route('shop.article.view', [$blog->category->slug . '/' . $blog->slug]) }}" class="text-uppercase btn-text-link">@lang('blog::app.shop.tag.read_more')</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            @else
                                            <div class="post-not-available">@lang('blog::app.shop.tag.no_posts')</div>
                                            @endif
                                        ...
                                        <div class=" column-3 blog-sidebar">
                                            <div class="row">
                                                <div class="col-lg-12 mb-4 categories">
                                                    <h3>@lang('blog::app.shop.tag.categories')</h3>
                                                    <ul class="list-group">
                                                    ...
                                                    <div class="tags-part">
                                                        <h3>@lang('blog::app.shop.tag.tags')</h3>
                                                        <div class="tag-list">
                                                            @foreach($tags as $tag)
